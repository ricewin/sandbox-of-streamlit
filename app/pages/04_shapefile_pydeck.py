...
def create_pydeck_map(gdf, fill_color=[255, 235, 215], line_color=[255, 250, 205], opacity=0.5):
    """
...
data_source = st.sidebar.radio(
    "Choose data source:",
    ["Sample Data", "Upload Shapefile", "Upload GeoJSON"]
)
...
if data_source == "Sample Data":
    ...
    **Required files:**
    ...
    prj_file = st.sidebar.file_uploader("Upload .prj file (optional)", type=['prj'], key='prj')
